...
var CommentComponent = (function () {
    ...
    CommentComponent.prototype.ngOnInit = function () {
        ...
        this._redditService.getSubreddit(this.p1, this.p2)
            .subscribe(function (c) { _this.post = c[0].data.children[0].data, _this.comments = c[1].data.children, console.log(c[1].data.children); }, null, function () { _this.isLoading = true; });
    };
